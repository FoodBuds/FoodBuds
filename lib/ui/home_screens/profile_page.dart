        ...
        return Column(
          ...
          children: <Widget>[
            ListTile(
              ...
              title: Text('Logout'),
              onTap: () => _confirmAction(context, 'Logout', _logout),
            ),
            ListTile(
              leading: Icon(Icons.delete, color: Colors.red),
              title: Text('Delete Account'),
              onTap: () => _confirmAction(context, 'Delete Account', deleteUser),
            ),
          ],
        );
      },
    ...
    return _photos.isEmpty
      ...
      child: Column(
        ...
        children: [
          ...
          Text('No photos uploaded.',style: TextStyle(
              color: Colors.white)),
          ElevatedButton(
...
class _ProfilePageState extends State<ProfilePage> {
            ...
            children: [
              Expanded(
                child: ElevatedButton(
                  ...
                  child: const Text("Info"),
                  style: ElevatedButton.styleFrom(
                    backgroundColor: _selectedIndex == 0 ? Colors.white : Colors.orange,
                    foregroundColor: _selectedIndex == 0 ? Colors.amber : Colors.white,
                  ),
                ),
              ),
              Expanded(
                child: ElevatedButton(
                  ...
                  child: const Text("Photos"), //
                  style: ElevatedButton.styleFrom(
                    backgroundColor: _selectedIndex == 1 ? Colors.white : Colors.orange,
                    foregroundColor: _selectedIndex == 1 ? Colors.amber : Colors.white,
                  ),
                ),
              ),
            ],
  ...
  Widget _buildPhotosTab() {
    return Center(
      child: Text("User's uploaded photos will be displayed here"),
    );
  }
}
